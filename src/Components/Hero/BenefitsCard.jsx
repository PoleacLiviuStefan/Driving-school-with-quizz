...
const BenefitsCard = ({titleCard,descriptionCard,iconCard,selected}) => {
  return (
    <div className={`flex flex-col py-[2rem] my-[1rem] lg:my-0 items-center w-[15rem] lg:w-[17rem] h-[18.5rem] lg:h-[21rem]  shadow-xl  rounded-[15px] ${selected ? "scale-[1.05] bg-red-600 text-white " :"bg-white text-black"} cursor-pointer`} >
