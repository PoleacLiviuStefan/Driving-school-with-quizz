  ...
  return (
    ...
    <div className="relative flex flex-col items-center w-full lg:w-[65rem] h-full ">
        <div className='absolute top-[-1rem] left-[1rem] lg:left-0 flex items-centert text-[12px]  lg:text-[14px] text-gray-500 '>
            ...
            <h2 className='text-[26px] lg:text-[42px] font-extrabold text-center leading'>CHESTIONARE AUTO<br/>  <span className='text-red-600'>PROBA TEORETICA</span></h2>
            ...
            <div className={`w-[90%] mt-[2rem] ${start!==3 && 'hidden'} flex flex-col items-center lg:text-[32px] font-extrabold`}>
               ...
               <button onClick={()=>setStart(4)} className='mt-[2rem] flex items-center bg-red-500 px-[4rem] py-[1rem] text-white font-bold text-[18px] lg:text-[24px] rounded-[8px] duration-300 transition ease-in-out hover:bg-red-600 hover:border-red-600 hover:shadow-[0px_0px_26px_-5px_#DC2626]'>INCEPE<span className='ml-1 text-[24px]'><AiOutlineArrowRight /></span></button>
            </div>
