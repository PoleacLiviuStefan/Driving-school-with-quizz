...
import prezentare from '../../Images/perfectionarePresentation.jpg'

const Improvments = () => {
  const navigate= useNavigate();
  return (
    <div className='relative mt-[5remrem] lg:mt-[5rem] flex flex-col justify-center items-center py-[5rem]  w-full h-full '>
        <Fade bottom>
